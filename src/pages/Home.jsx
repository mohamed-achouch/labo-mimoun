    ...
    <section className="">
      <div className="h-[650px] w-full  relative  ">
        ...
        <div className=" absolute bottom-[100px] right-0">
          <div className=" z-20 relative   right-0 px-2 sm:px-4 md:px-10 lg:px-20 xl:px-32  flex flex-col gap-6 items-end  justify-end">
            ...
            <a
              href="/"
              className=" flex items-center text-white  border-white border-[2px] gap-2 py-2 px-6 rounded-sm"
            >
      ...
      <div className=" flex flex-col gap-8  mt-5 px-2 sm:px-4 md:px-10 lg:px-20 xl:px-32">
        ...
        <div className=" flex flex-col gap-6">
          <MainTitle name="Dépannage express" />
          <p className=" text-custom-primary text-[14px]">
            Chez unisson, vous povez faire entretenir et réparer vos{" "}
            <span className=" text-custom-secondary">appareils auditifs</span>,
            quel que soit le type qu l'ancienneté de votre équipement, Lorem
            ipsum dolor sit amet consectetur adipisicing elit. Dolorum
            voluptatem aperiam fuga, qui, saepe magnam doloremque delectus
            consectetur voluptas totam asperiores dignissimos earum ex obcaecati
            voluptate ullam consequuntur quidem placeat?
          </p>
          <p className=" text-custom-primary text-[14px]">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ab,
            pariatur!{" "}
        ...
        <h1 className=" text-custom-primary font-bold">Un devis vous est systématiquement remis avant la réparation.</h1>
        <div>
          <p className=" text-custom-primary text-[14px]">*nom remboursé</p>
          
          <p className=" text-custom-primary text-[14px]">**en partie remboursé par la sésu et votre mutuelle</p>
        </div>
      </div>
      <div className=" mt-6 bg-custom-primary text-white py-12 px-2  sm:px-4 md:px-10 lg:px-20 xl:px-32">
          <div className=" flex-col md:flex-row flex justify-between gap-4  items-center">
                    <h1 className=" text-center md:text-start text-[20px]  font-medium">Prenez rendez-vous <br /> pour un bilan auditif gratuit</h1>  
            <Button icon={ <LuCalendarDays/>} rounded="rounded-sm" title="Prendre rendez-vous" color="bg-custom-secondary"/>
          </div>
      </div>
      <div className=" my-[100px]  gap-[20px]  px-2  sm:px-4 md:px-10 lg:px-20 xl:px-32 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
      {
        valeurs.map((serv)=>(
            <div className=" shadow py-4 px-2 flex  flex-col gap-2 items-center">
                <img className=" rounded-md object-fill w-[40px] h-[40px] md:h-[60px] md:w-[60px] lg:w-[70px] lg:h-[70px]" src={serv.image} alt={serv.name} />
                <h1 className=" text-center   text-[14px] text-custom-primary font-bold">{serv.name}</h1>
                <p className=" text-custom-primary/80 text-[14px] text-center font-semibold">{serv.desc}</p>
            </div>
        ))
      }
      </div>
      <div className=" px-2  sm:px-4 md:px-10 lg:px-20 xl:px-32">
      <h1 className=' m-auto w-fit text-custom-primary text-[20px] font-semibold relative before:content-[""] before:absolute before:-bottom-2 before:top-[40px] before:right-0 before:left-0 before:m-auto before:h-1 before:w-[120px] before:bg-custom-secondary'>Nos Marques Partenaires</h1>
       <div className=" mt-[60px] flex justify-around items-center gap-10 flex-col md:flex-row">
           <img src={img1} alt=""  className=" w-[100px] md:w-[150px] lg:w-[220px]"/>
           <img src={img2} alt=""  className=" w-[100px] md:w-[150px] lg:w-[220px]"/>
       </div>
       </div>
    </section>
  );
